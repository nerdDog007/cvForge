...
const Faq = () => {
  return (
    <div className="w-screen">
        <h1 className="text-[.8rem] font-bold sm:text-2xl md:text-3xl lg:text-4xl text-center">Frequently Asked Questions</h1>
    ...
    return (
      ...
      >
        <div className="flex flex-col gap-2 w-[90%]">
          <p className="text-[1rem] sm:text-[1.4rem] font-medium">{props.title}</p>
        ...
        <FaAngleDown
          className={`text-white text-[1rem] sm:text-[1.4rem] w-[10%] cursor-pointer transition-transform duration-300 ${
